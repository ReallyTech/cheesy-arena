...
func (web *Web) rankingsPdfReportHandler(w http.ResponseWriter, r *http.Request) {
	...
	pdf.CellFormat(colWidths["AutoT"], rowHeight, "AutoT", "1", 0, "C", true, 0, "")
	...
	for _, ranking := range rankings {
		...
		pdf.CellFormat(colWidths["Auto"], rowHeight, strconv.Itoa(ranking.AutoFuelPoints), "1", 0, "C", false, 0, "")
		pdf.CellFormat(colWidths["AutoT"], rowHeight, strconv.Itoa(ranking.AutoTowerPoints), "1", 0, "C", false, 0, "")
