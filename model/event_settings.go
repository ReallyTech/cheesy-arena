...
type EventSettings struct {
	...
	FuelEnergizedThreshold           int
	FuelSuperchargedThreshold        int
	TowerTraversalThreshold          int
}
...
func (database *Database) GetEventSettings() (*EventSettings, error) {
	...
	eventSettings := EventSettings{
		...
		FuelEnergizedThreshold:      game.FuelEnergizedThreshold,
		FuelSuperchargedThreshold:   game.FuelSuperchargedThreshold,
		TowerTraversalThreshold:     game.TowerTraversalThreshold,
	}
