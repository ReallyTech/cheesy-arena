...
func (web *Web) newHandler() http.Handler {
	...
	mux.HandleFunc("GET /displays/alliance_hub", web.allianceHubDisplayHandler)
	mux.HandleFunc("GET /displays/alliance_hub/websocket", web.allianceHubDisplayWebsocketHandler)
