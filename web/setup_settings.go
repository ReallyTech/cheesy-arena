...
func (web *Web) settingsPostHandler(w http.ResponseWriter, r *http.Request) {
	...
	eventSettings.WrtApEnabled = r.PostFormValue("wrtApEnabled") == "on"
	...
	eventSettings.SwitchRpcUrl = r.PostFormValue("switchRpcUrl")
	...
	eventSettings.FuelEnergizedThreshold, _ = strconv.Atoi(r.PostFormValue("fuelEnergizedThreshold"))
	eventSettings.FuelSuperchargedThreshold, _ = strconv.Atoi(r.PostFormValue("fuelSuperchargedThreshold"))
	eventSettings.TowerTraversalThreshold, _ = strconv.Atoi(r.PostFormValue("towerTraversalThreshold"))
